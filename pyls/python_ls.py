...
class PythonLanguageServer(MethodDispatcher):
    ...
    def lint(self, socket_id, doc_uri, is_saved):
    ...
    def m_text_document__did_close(self, socket_id, textDocument=None, **_kwargs):
        workspace = self._match_uri_to_workspace(textDocument['uri'])
        workspace.rm_document(textDocument['uri'])
        # self.workspaces.pop(textDocument['uri'])

    def m_text_document__did_open(self, socket_id, textDocument=None, **_kwargs):
        workspace = self._match_uri_to_workspace(textDocument['uri'])
        ...
        self.lint(socket_id, textDocument['uri'], is_saved=True)

    def m_text_document__did_change(self, socket_id, contentChanges=None, textDocument=None, **_kwargs):
        workspace = self._match_uri_to_workspace(textDocument['uri'])
        ...
        self.lint(socket_id,textDocument['uri'], is_saved=False)

    def m_text_document__did_save(self, socket_id, textDocument=None, **_kwargs):
        self.lint(socket_id, textDocument['uri'], is_saved=True)

    def m_text_document__code_action(self, socket_id, textDocument=None, range=None, context=None, **_kwargs):
        return self.code_actions(textDocument['uri'], range, context)

    def m_text_document__code_lens(self, socket_id, textDocument=None, **_kwargs):
        return self.code_lens(textDocument['uri'])

    def m_text_document__completion(self, socket_id, textDocument=None, position=None, **_kwargs):
        return self.completions(textDocument['uri'], position)

    def m_text_document__definition(self, socket_id, textDocument=None, position=None, **_kwargs):
        return self.definitions(textDocument['uri'], position)

    def m_text_document__document_highlight(self, socket_id, textDocument=None, position=None, **_kwargs):
        return self.highlight(textDocument['uri'], position)

    def m_text_document__hover(self, socket_id, textDocument=None, position=None, **_kwargs):
        return self.hover(textDocument['uri'], position)

    def m_text_document__document_symbol(self, socket_id, textDocument=None, **_kwargs):
        return self.document_symbols(textDocument['uri'])

    def m_text_document__formatting(self, socket_id, textDocument=None, _options=None, **_kwargs):
        # For now we're ignoring formatting options.
        return self.format_document(textDocument['uri'])

    def m_text_document__rename(self, socket_id, textDocument=None, position=None, newName=None, **_kwargs):
        return self.rename(textDocument['uri'], position, newName)

    def m_text_document__folding_range(self, socket_id, textDocument=None, **_kwargs):
        return self.folding(textDocument['uri'])

    def m_text_document__range_formatting(self, socket_id, textDocument=None, range=None, _options=None, **_kwargs):
        # Again, we'll ignore formatting options for now.
        return self.format_range(textDocument['uri'], range)

    def m_text_document__references(self, socket_id, textDocument=None, position=None, context=None, **_kwargs):
        exclude_declaration = not context['includeDeclaration']
        return self.references(textDocument['uri'], position, exclude_declaration)

    def m_text_document__signature_help(self, socket_id, textDocument=None, position=None, **_kwargs):
        return self.signature_help(textDocument['uri'], position)

    def m_workspace__did_change_configuration(self, socket_id, settings=None):
        self.config.update((settings or {}).get('pyls', {}))
        for workspace_uri in self.workspaces:
            workspace = self.workspaces[workspace_uri]
            workspace.update_config(settings)
            for doc_uri in workspace.documents:
                self.lint(socket_id, doc_uri, is_saved=False)

    def m_workspace__did_change_workspace_folders(self, socket_id, event=None, **_kwargs):
        if event is None:
            return
    ...
    def m_workspace__did_change_watched_files(self, socket_id, changes=None, **_kwargs):
    ...
    def m_workspace__execute_command(self, socket_id, command=None, arguments=None):
